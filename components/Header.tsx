...
<header className={`${isScrolled && "bg-[#141414]" }`}>
  ...
  <div className="flex items-center text-sm space-x-4 font-light">
    <MagnifyingGlassIcon className="hidden h-6 w-6 text-white sm:inline" />
    <p className="hidden headerLink lg:inline">Kids</p>
    <BellIcon className="h-6 w-6 text-white inline" />
    <Link href="/account">
